...
class Item:
    ...
    def apply_discount(self):
        ...
        self.__item_price = self.__item_price * self.pay_rate

    def apply_increment(self, increment):
        self.__item_price = self.__item_price + self.__item_price * increment
    ...
    def calculate_total_price(self):
        return self.__item_price * self.item_quantity
    ...
    def __prepare_body(self):
        return f"""
        Hello someone.
        We sold {self.item_name} with quantity: {self.item_quantity}.
        Best regards,
        Vinh
        """
